    ...
    <div style={{ minHeight:"100vh", fontFamily:"Inter,sans-serif", background:"var(--bg)" }}>
      ...
      <nav style={{ display:"flex", alignItems:"center", justifyContent:"space-between",
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"0.6rem" }}>
          <div style={{ width:28, height:28, borderRadius:7, background:C.amber,
                        display:"flex", alignItems:"center", justifyContent:"center" }}>
            <div style={{ width:10, height:10, borderRadius:"50%", background:"var(--white)" }}/>
          </div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"1.25rem" }}>
            {[
              ...
              { title:"Travel and Logistics",
                desc:"Voice-triggered flight searches, booking workflows, and itinerary management. Just say where you want to go.",
                live:true },
    ...
    <div style={{ minHeight:"100vh", background:"var(--bg)",
      ...
      <div style={{ background:"var(--white)", borderRadius:20, padding:"2.5rem", width:420,
        ...
        <div style={{ textAlign:"center", marginBottom:"1.75rem" }}>
          <div style={{ width:44,height:44,borderRadius:12,background:C.amber,
                        display:"flex",alignItems:"center",justifyContent:"center",
                        margin:"0 auto 1rem",
                        boxShadow:"0 4px 12px rgba(245,167,0,0.3)" }}>
